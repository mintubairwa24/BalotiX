/**
 * FILE: src/store/ADMIN_PRODUCTS_store_index_update.js
 *
 * ============================================================================
 * src/store/index.js — UPDATE SNIPPET (Phase 18A)
 * ============================================================================
 * Add this single export line to your existing store barrel, alongside the
 * 10 stores already there (9 original + adminDashboard.store from Phase 17).
 *
...
/**
 * Resulting file should look like (illustrative — keep your existing 10
 * lines, just add the new one):
 */
...
// export { useAdminProductsStore } from "./adminProducts.store";  // <-- NEW
