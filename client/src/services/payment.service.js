...
const PAYMENT_ENDPOINTS = {
  CREATE_SESSION: "/payments/create",     // POST - create Razorpay order for an existing Order
  VERIFY: "/payments/verify",             // POST - forward Razorpay response for backend verification
  GET_STATUS: (orderId) => `/payments/status/${orderId}`, // GET - current payment status for an order
};
